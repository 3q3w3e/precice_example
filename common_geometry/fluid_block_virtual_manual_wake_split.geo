...
wall_cluster = 1.1;        // wall-normal clustering toward cylinder/beam surfaces
...
n_cylinder_beam_arc = Max(3, Round((n_cylinder_beam_arc_manual - 1) * mesh_scale) + 1);
// Surface 114/115 use composite sides: curve 33/37 plus beam line 18/21.
// The opposite outer C-grid side must follow this manual arc count.
nx_xcs_outer_left = nx_xcs_inner_left + n_cylinder_beam_arc - 1;
...
Transfinite Curve{33, 37} = n_cylinder_beam_arc;
