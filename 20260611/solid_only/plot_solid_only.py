#!/usr/bin/env python3
# coding=utf-8
"""Plot the CSV produced by run_solid_only.py."""
...
def main():
    csv_path = Path(sys.argv[1] if len(sys.argv) > 1 else "solid_only.csv")
    ...
    fig.suptitle(f"Solid-only transient: {csv_path.name}")
    fig.tight_layout()
